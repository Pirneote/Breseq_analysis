...
INPUT_DIR="/pub/trosazza/Sequence/Pp_EE"

# Set output base directory for Breseq results
OUTPUT_BASE_DIR="/pub/trosazza/Breseq"

# Define reference genome paths
REFERENCE_GENOME1="/pub/trosazza/Sequence/Reference/Pp_KT2440.gbk"
#REFERENCE_GENOME2="/pub/trosazza/Sequence/Aj_EE/Aj_Anc_nR365-L2-G4-P017-TGCAGCTA-ACTCTAGG-READ2-Sequences.txt.gz"

# Find all READ1 files that start with 'Pp_BA_Mix' and loop through them
for READ1 in ${INPUT_DIR}/Pp_BABen120_PP*READ1-Sequences.txt.gz; do
